...
async def predict_plant(sepal_length: float, sepal_width: float, petal_length: float, petal_width: float) -> dict:
    """
    Predict type of plant. <br>
    :param sepal_length: float - sepal length (cm) <br>
    :param sepal_width: float - sepal width (cm) <br>
    :param petal_length: float - petal length (cm) <br>
    :param petal_width: float -  petal width (cm) <br>
    :return: str - ["setosa", "versicolor", "virginica"]
    """

    return {'label_predicted': MODEL.predict([[sepal_length, sepal_width, petal_length, petal_width]])[0]}
